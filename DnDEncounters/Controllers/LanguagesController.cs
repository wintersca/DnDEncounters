...
namespace DnDEncounters.Controllers
{
    public class LanguagesController : Controller
    {
        ...
        public LanguagesController(DnDEncounterContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("LanguageID,Description")] Language language)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LanguageID,Description")] Language language)
        {
